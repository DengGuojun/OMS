...
public class SalesOrderRequestBean {
	...
	private List<SalesOrderItemRequestBean> salesOrderItemList;
	...
	public List<SalesOrderItemRequestBean> getSalesOrderItemList() {
		return salesOrderItemList;
	}

	public void setSalesOrderItemList(List<SalesOrderItemRequestBean> salesOrderItemList) {
