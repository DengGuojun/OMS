...
public final class OmsServicePrxHelper extends Ice.ObjectPrxHelperBase implements OmsServicePrx
{
    ...
    public Ice.AsyncResult begin_rpc(String method, String params, Callback_OmsService_rpc __cb)
    {
        return begin_rpc(method, params, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_rpc(String method, String params, java.util.Map<String, String> __ctx, Callback_OmsService_rpc __cb)
    {
        return begin_rpc(method, params, __ctx, true, false, __cb);
    }
                         ...
                         new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                             {
                                 ...
                                 {
                                     OmsServicePrxHelper.__rpc_completed(this, __result);
                                 }
                             });
    }
    ...
    {
        com.lpmas.oms.component.OmsServicePrx __proxy = (com.lpmas.oms.component.OmsServicePrx)__result.getProxy();
        String __ret = null;
        try
        {
    ...
    public static OmsServicePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), OmsServicePrx.class, OmsServicePrxHelper.class);
    }

    public static OmsServicePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), OmsServicePrx.class, OmsServicePrxHelper.class);
    }

    public static OmsServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), OmsServicePrx.class, OmsServicePrxHelper.class);
    }

    public static OmsServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), OmsServicePrx.class, OmsServicePrxHelper.class);
    }

    public static OmsServicePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, OmsServicePrx.class, OmsServicePrxHelper.class);
    }

    public static OmsServicePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, OmsServicePrx.class, OmsServicePrxHelper.class);
    }

    public static final String[] __ids =
    {
        "::Ice::Object",
        "::com::lpmas::oms::component::OmsService"
    };
    ...
    public static void __write(IceInternal.BasicStream __os, OmsServicePrx v)
    {
        __os.writeProxy(v);
    }

    public static OmsServicePrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            OmsServicePrxHelper result = new OmsServicePrxHelper();
